...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FN] = LAYOUT_109_ansi(
        ...
        _______,  _______,   _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,   _______,     _______,  _______,  _______,  _______,  _______,       KC_MS_U,       _______,     _______,
        KC_CAPS,  _______,   _______,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,   _______,                _______,                                KC_MS_L,       KC_BTN1,       KC_MS_R,
        _______,             _______,   _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,   _______,                _______,            KC_WH_U,            _______,       KC_MS_D,       _______,     _______,
    ...
    [WIN_BASE] = LAYOUT_109_ansi(
        ...
        KC_LSFT,             KC_Z,      KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,                KC_RSFT,            KC_UP,              KC_P1,         KC_P2,         KC_P3,       KC_PENT,
        KC_LCTL,  KC_LALT,   KC_RCTL,                                 KC_SPC,                                 KC_RWIN,   KC_RALT,   MO(WIN_FN),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,                        KC_PDOT            ),
    [GAMING] = LAYOUT_109_ansi(
        ...
        KC_LSFT,             KC_Z,      KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,    KC_SLSH,                KC_RSFT,            KC_UP,              KC_P1,         KC_P2,         KC_P3,       KC_PENT,
        XXXXXXX,  KC_LALT,   KC_LCTL,                                 KC_SPC,                                 KC_RWIN,   KC_RALT,   MO(WIN_FN),  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,                        KC_PDOT            ),
...
static bool fn_key_pressed_alone = false;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    // Trick to allow the Fn key function as both the Fn key and the menu key.
    if (keycode == MO(MAC_FN) || keycode == MO(WIN_FN)) {
        if (record->event.pressed) {
            fn_key_pressed_alone = true;
        } else {
            if (fn_key_pressed_alone) {
